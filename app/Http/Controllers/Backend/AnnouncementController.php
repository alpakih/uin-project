...
class AnnouncementController extends Controller
{
    ...
    {
        parent::__construct();
        $this->menu = trans('menu.announcement.name');
        $this->route = $this->routes['backend'] . 'announcement';
        $this->slug = $this->slugs['backend'] . 'announcement';
        $this->view = $this->views['backend'] . 'cms.announcement';
